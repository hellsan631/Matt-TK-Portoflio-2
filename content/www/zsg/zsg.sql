...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2012 at 03:04 AM
...
INSERT INTO `admin` (`id`, `last_news_item_id`, `home_page`, `games_page`, `contact`, `company`) VALUES
...
INSERT INTO `news` (`id`, `title`, `content`, `date`, `type`, `blurb`) VALUES
...
INSERT INTO `users` (`id`, `username`, `email`, `salt`, `password`, `avatar`, `userlevel`, `fname`, `lname`, `logins`, `lastip`, `lastlogindate`) VALUES
